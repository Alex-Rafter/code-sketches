...
function filterRules(doc, objCss, taskTimerRecord) {
    ...
    const fragment = parser.parseFromString(doc, "text/html");

    const descendantsCount = fragment.querySelectorAll('*').length;
                        ...
                        if (typeof rule === 'string') {
                            ...
                            arrSel.forEach(function (sel) {
                                ...
                                if (sel.length < MaxPossiblePseudoLength && sel.match(REG0)) {
                                    ...
                                    try {
                                        if (
                                            fragment.matches(replacedSel) ||
                                            fragment.querySelectorAll(replacedSel).length !== 0
                                        ) {
                                            selMatched.push(sel)
                                        }
                                    } catch (e) {
