<?php
	...
	<div class="wrap about__container">
		...
		<div class="about__header">
			<div class="about__header-title">
				<h1>
					<?php
 printf( __( 'WordPress %s' ), str_replace( '.', '<span>.</span>', $display_version ) ); ?>
				</h1>
			</div>
 ...
 printf( __( 'Welcome to WordPress %s' ), $display_version ); ?>
				...
				<p class="is-subheading aligncenter">
					<?php
 printf( __( 'WordPress 6.2 includes more than %1$s enhancements and %2$s bug fixes. This page highlights the latest features since the November 2022 release of WordPress 6.1. From quick highlights to developer resources, there&#8217;s a lot to explore.' ), 292, 394 ); ?>
				</p>
			</div>
		</div>
 ...
 printf( __( 'Learn more about WordPress %s' ), $display_version ); ?>
				...
				<p class="is-subheading">
					<?php
 printf( __( 'Explore <a href="%s">learn.wordpress.org</a> for tutorial videos, online workshops, courses, and lesson plans for Meetup organizers, including new features in WordPress.' ), 'https://learn.wordpress.org/' ); ?>
				</p>
			</div>
		</div>
		...
		<div class="about__section has-2-columns">
			<div class="column">
				...
				<p>
					<?php
 printf( __( 'Check out the latest version of the <a href="%s">WordPress Field Guide</a>. It is overflowing with detailed developer notes to help you build with WordPress.' ), __( 'https://make.wordpress.org/core/2023/03/09/wordpress-6-2-field-guide/' ) ); ?>
				</p>
			</div>
			<div class="column">
				<div class="about__image">
				...
				<p>
					<?php
 printf( __( '<a href="%1$s">Read the WordPress %2$s Release Notes</a> for more information on the included enhancements and issues fixed, installation information, developer notes and resources, release contributors, and the list of file changes in this release.' ), sprintf( esc_url( __( 'https://wordpress.org/support/wordpress-version/version-%s/' ) ), '6-2' ), '6.2' ); ?>
				</p>
			</div>
		</div>
